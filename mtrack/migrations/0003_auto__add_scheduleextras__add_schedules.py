...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding model 'ScheduleExtras'
        db.create_table(u'schedule_extras', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('schedule', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['mtrack.Schedules'])),
            ('recipient_location_type', self.gf('django.db.models.fields.TextField')(null=True, blank=True)),
            ('recipient_location', self.gf('django.db.models.fields.TextField')(null=True, blank=True)),
            ('allowed_recipients', self.gf('django.db.models.fields.TextField')(default='all')),
            ('recipient_group_type', self.gf('django.db.models.fields.TextField')(null=True, blank=True)),
            ('group_ref', self.gf('django.db.models.fields.TextField')(null=True, blank=True)),
            ('missing_reports', self.gf('django.db.models.fields.TextField')(default='')),
            ('expected_reporter', self.gf('django.db.models.fields.TextField')(default='HC')),
            ('is_message_temp', self.gf('django.db.models.fields.BooleanField')(default=False)),
            ('message_args', self.gf('django.db.models.fields.TextField')(default='')),
            ('return_code', self.gf('django.db.models.fields.TextField')(default='')),
            ('cdate', self.gf('django.db.models.fields.DateTimeField')(default=datetime.datetime(2012, 8, 30, 11, 43, 47, 626495))),
        ))
        db.send_create_signal('mtrack', ['ScheduleExtras'])

        # Adding model 'Schedules'
        db.create_table(u'schedules', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('created_by', self.gf('django.db.models.fields.TextField')(default='')),
            ('start_date', self.gf('django.db.models.fields.DateField')()),
            ('end_date', self.gf('django.db.models.fields.DateField')(null=True, blank=True)),
            ('start_time', self.gf('django.db.models.fields.TimeField')(null=True, blank=True)),
            ('message_type', self.gf('django.db.models.fields.TextField')()),
            ('message', self.gf('django.db.models.fields.TextField')()),
            ('recur_frequency', self.gf('django.db.models.fields.IntegerField')(default=0)),
            ('recur_interval', self.gf('django.db.models.fields.TextField')(default='none')),
            ('recur_day', self.gf('django.db.models.fields.TextField')(default='')),
            ('recur_weeknumber', self.gf('django.db.models.fields.IntegerField')(null=True, blank=True)),
            ('enabled', self.gf('django.db.models.fields.BooleanField')(default=True)),
        ))
        db.send_create_signal('mtrack', ['Schedules'])


    def backwards(self, orm):
        
        # Deleting model 'ScheduleExtras'
        db.delete_table(u'schedule_extras')

        # Deleting model 'Schedules'
        db.delete_table(u'schedules')
    ...
    models = {
        ...
        'mtrack.scheduleextras': {
            ...
            'cdate': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2012, 8, 30, 11, 43, 47, 626495)'}),
