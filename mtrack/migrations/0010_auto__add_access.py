...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'Access'
        db.create_table('mtrack_access', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('user', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['auth.User'])),
            ('url_denied', self.gf('django.db.models.fields.CharField')(max_length=200)),
        ))
        db.send_create_signal('mtrack', ['Access'])


    def backwards(self, orm):
        # Deleting model 'Access'
        db.delete_table('mtrack_access')
    ...
    models = {
        ...
        'mtrack.access': {
            ...
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'url_denied': ('django.db.models.fields.CharField', [], {'max_length': '200'}),
