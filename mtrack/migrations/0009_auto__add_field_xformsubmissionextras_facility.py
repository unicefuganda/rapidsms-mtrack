...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'XFormSubmissionExtras.facility'
        db.add_column('rapidsms_xforms_xformsubmissionextras', 'facility',
                      self.gf('django.db.models.fields.related.ForeignKey')(to=orm['healthmodels.HealthFacilityBase'], null=True, blank=True),
                      keep_default=False)

        # Adding field 'XFormSubmissionExtras.reporter'
        db.add_column('rapidsms_xforms_xformsubmissionextras', 'reporter',
                      self.gf('django.db.models.fields.related.ForeignKey')(to=orm['healthmodels.HealthProviderBase'], null=True, blank=True),
                      keep_default=False)

        # Adding unique constraint on 'XFormSubmissionExtras', fields ['submission']
        db.create_unique('rapidsms_xforms_xformsubmissionextras', ['submission_id'])
        run_file('0009_auto__add_field_xformsubmissionextras_facility.sql')


    def backwards(self, orm):
        # Removing unique constraint on 'XFormSubmissionExtras', fields ['submission']
        db.delete_unique('rapidsms_xforms_xformsubmissionextras', ['submission_id'])

        # Deleting field 'XFormSubmissionExtras.facility'
        db.delete_column('rapidsms_xforms_xformsubmissionextras', 'facility_id')

        # Deleting field 'XFormSubmissionExtras.reporter'
        db.delete_column('rapidsms_xforms_xformsubmissionextras', 'reporter_id')
        run_file('0009_auto__add_field_xformsubmissionextras_facility_back.sql')
    ...
    models = {
        ...
        'mtrack.scheduleextras': {
            ...
            'cdate': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2013, 1, 6, 0, 0)'}),
        ...
        'mtrack.xformsubmissionextras': {
            ...
            'facility': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['healthmodels.HealthFacilityBase']", 'null': 'True', 'blank': 'True'}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'is_late_report': ('django.db.models.fields.BooleanField', [], {'default': 'False'}),
            'reporter': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['healthmodels.HealthProviderBase']", 'null': 'True', 'blank': 'True'}),
            'submission': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['rapidsms_xforms.XFormSubmission']", 'unique': 'True'}),
