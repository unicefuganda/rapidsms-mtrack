...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding model 'XFormSubmissionExtras'
        db.create_table('rapidsms_xforms_xformsubmissionextras', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('submission', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['rapidsms_xforms.XFormSubmission'])),
            ('is_late_report', self.gf('django.db.models.fields.BooleanField')(default=False)),
            ('submitted_by', self.gf('django.db.models.fields.TextField')(null=True)),
            ('cdate', self.gf('django.db.models.fields.DateTimeField')(auto_now_add=True, blank=True)),
        ))
        db.send_create_signal('mtrack', ['XFormSubmissionExtras'])


    def backwards(self, orm):
        
        # Deleting model 'XFormSubmissionExtras'
        db.delete_table('rapidsms_xforms_xformsubmissionextras')
