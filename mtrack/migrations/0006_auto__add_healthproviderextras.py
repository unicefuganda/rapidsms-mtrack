...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding model 'HealthProviderExtras'
        db.create_table('healthmodels_healthproviderextras', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('health_provider', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['healthmodels.HealthProvider'], unique=True)),
            ('total_reports', self.gf('django.db.models.fields.IntegerField')(default=0)),
            ('district', self.gf('django.db.models.fields.TextField')()),
        ))
        db.send_create_signal('mtrack', ['HealthProviderExtras'])


    def backwards(self, orm):
        
        # Deleting model 'HealthProviderExtras'
        db.delete_table('healthmodels_healthproviderextras')
