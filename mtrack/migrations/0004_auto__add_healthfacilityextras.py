...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding model 'HealthFacilityExtras'
        db.create_table('healthmodels_healthfacilityextras', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('health_facility', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['healthmodels.HealthFacility'], unique=True)),
            ('total_reports', self.gf('django.db.models.fields.IntegerField')(default=0)),
            ('total_reporters', self.gf('django.db.models.fields.IntegerField')(default=0)),
            ('catchment_areas_list', self.gf('django.db.models.fields.TextField')(default='')),
        ))
        db.send_create_signal('mtrack', ['HealthFacilityExtras'])


    def backwards(self, orm):
        
        # Deleting model 'HealthFacilityExtras'
        db.delete_table('healthmodels_healthfacilityextras')
    ...
    models = {
        ...
        'mtrack.scheduleextras': {
            ...
            'cdate': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2012, 9, 12, 15, 19, 42, 481389)'}),
