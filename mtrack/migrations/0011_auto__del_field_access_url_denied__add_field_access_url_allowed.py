...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'Access.url_denied'
        db.delete_column('mtrack_access', 'url_denied')

        # Adding field 'Access.url_allowed'
        db.add_column('mtrack_access', 'url_allowed',
                      self.gf('django.db.models.fields.CharField')(default='^approve/', max_length=200),
                      keep_default=False)


    def backwards(self, orm):
        # Adding field 'Access.url_denied'
        db.add_column('mtrack_access', 'url_denied',
                      self.gf('django.db.models.fields.CharField')(default='/', max_length=200),
                      keep_default=False)

        # Deleting field 'Access.url_allowed'
        db.delete_column('mtrack_access', 'url_allowed')
    ...
    models = {
        ...
        'mtrack.access': {
            ...
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'url_allowed': ('django.db.models.fields.CharField', [], {'max_length': '200'}),
        ...
        'mtrack.scheduleextras': {
            ...
            'cdate': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2013, 2, 13, 0, 0)'}),
