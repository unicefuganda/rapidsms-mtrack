...
class Migration(SchemaMigration):
    depends_on = (
        ('healthmodels','0006_auto__add_field_healthfacilitybase_last_reporting_date'),
    )
    def forwards(self, orm):
        
        # Adding model 'AnonymousReport'
        db.create_table('mtrack_anonymousreport', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('connection', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['rapidsms.Connection'])),
            ('date', self.gf('django.db.models.fields.DateTimeField')(auto_now_add=True, blank=True)),
            ('district', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['locations.Location'], null=True)),
            ('comments', self.gf('django.db.models.fields.TextField')(null=True)),
            ('health_facility', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['healthmodels.HealthFacility'], null=True)),
            ('action', self.gf('django.db.models.fields.CharField')(default='Op', max_length=2)),
            ('topic', self.gf('django.db.models.fields.CharField')(default='Unknown', max_length=32, null=True)),
            ('action_center', self.gf('django.db.models.fields.CharField')(default='', max_length=32, null=True)),
            ('action_taken', self.gf('django.db.models.fields.TextField')(null=True)),
        ))
        db.send_create_signal('mtrack', ['AnonymousReport'])

        # Adding M2M table for field messages on 'AnonymousReport'
        db.create_table('mtrack_anonymousreport_messages', (
            ('id', models.AutoField(verbose_name='ID', primary_key=True, auto_created=True)),
            ('anonymousreport', models.ForeignKey(orm['mtrack.anonymousreport'], null=False)),
            ('message', models.ForeignKey(orm['rapidsms_httprouter.message'], null=False))
        ))
        db.create_unique('mtrack_anonymousreport_messages', ['anonymousreport_id', 'message_id'])


    def backwards(self, orm):
        
        # Deleting model 'AnonymousReport'
        db.delete_table('mtrack_anonymousreport')

        # Removing M2M table for field messages on 'AnonymousReport'
        db.delete_table('mtrack_anonymousreport_messages')
